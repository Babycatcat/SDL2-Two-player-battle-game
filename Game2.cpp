...
void game2()
{
	...
	char deco0[100] = "../image/background/house2.png";
	...
	Role house("../image/background/house2.png", renderer);
	Wall stone1("../image/background/wall4-1.jpg", renderer);
	Grass grass("../image/background/grass.png", renderer);
	Role rob("../image/background/back2.jpg", 1, 1, 1, renderer);
